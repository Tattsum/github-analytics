...
// Mutate calls f(ctx, m).
func (f MemberRepoStatFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MemberRepoStatMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MemberRepoStatMutation", m)
}

// The MemberStatFunc type is an adapter to allow the use of ordinary
// function as MemberStat mutator.
type MemberStatFunc func(context.Context, *ent.MemberStatMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MemberStatFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MemberStatMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MemberStatMutation", m)
}

// The MemberYearStatFunc type is an adapter to allow the use of ordinary
// function as MemberYearStat mutator.
type MemberYearStatFunc func(context.Context, *ent.MemberYearStatMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MemberYearStatFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MemberYearStatMutation); ok {
		return f(ctx, mv)
	}
