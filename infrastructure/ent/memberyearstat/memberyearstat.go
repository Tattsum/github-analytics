...
const (
	// Label holds the string label denoting the memberyearstat type in the database.
	Label = "member_year_stat"
	...
	// Table holds the table name of the memberyearstat in the database.
	Table = "member_year_stats"
	// SnapshotTable is the table that holds the snapshot relation/edge.
	SnapshotTable = "member_year_stats"
	...
	SnapshotColumn = "snapshot_member_year_stats"
)

// Columns holds all SQL columns for memberyearstat fields.
var Columns = []string{
	FieldID,
	FieldLogin,
	FieldYear,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "member_year_stats"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"snapshot_member_year_stats",
}
...
// OrderOption defines the ordering options for the MemberYearStat queries.
