...
const (
	// Label holds the string label denoting the memberrepostat type in the database.
	Label = "member_repo_stat"
	...
	// Table holds the table name of the memberrepostat in the database.
	Table = "member_repo_stats"
	// SnapshotTable is the table that holds the snapshot relation/edge.
	SnapshotTable = "member_repo_stats"
	...
	SnapshotColumn = "snapshot_member_repo_stats"
)

// Columns holds all SQL columns for memberrepostat fields.
var Columns = []string{
	FieldID,
	FieldLogin,
	FieldNameWithOwner,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "member_repo_stats"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"snapshot_member_repo_stats",
}
...
// OrderOption defines the ordering options for the MemberRepoStat queries.
